...
public class TestDataPopulator {
    ...
    public TestDataPopulator() {
        ...
        producersDASData.getData().add(
//                new Producer
//                (new ProducerScope("200", "100", "100", "2"),
                        new ProducerTime("2", "2018-09-01", "2018-10-15", "24", "10"));
        producersDASData.getData().add(
//                new Producer
//                (new ProducerScope("100", "100", "100", "2"),
                        new ProducerTime("2", "2018-09-01", "2018-10-15", "12","10"));
        producersDASData.getData().add(
//                new Producer
...
//                (new ProducerScope("50", "50", "50", "1"),
                        new ProducerTime("2", "2018-10-01", "2018-11-15", "24","10"));
        producersDASData.getData().add(
//                new Producer
//                (new ProducerScope("100", "50", "50", "1"),
                        new ProducerTime("2", "2018-09-01", "2018-09-15", "24","10"));
